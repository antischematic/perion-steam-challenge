...
import {
  formatHours,
  formatInteger,
  getSteamGameLargeCapsule,
} from '@perion.steam.challenge/utils';
  ...
  return (
    <>
      ...
      <div className={styles.playtimeAcrossAllGames}>
        <p>
          Across all games {playerName} has played for{' '}
          <strong>{formatHours(playtimeAcrossAllGames)} hours</strong>
        </p>
        <p>
          That&rsquo;s about the time it takes to read{' '}
          <strong>
            {formatInteger(
              playtimeAcrossAllGames / (60 * AVERAGE_TIME_TO_READ_A_BOOK_HOURS)
            )}{' '}
            books
          </strong>
        </p>
