...
import React, {DetailedHTMLProps, HTMLAttributes, ReactElement, useRef} from "react";
...
export interface VirtualScrollProps<T> extends Omit<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, 'children'> {
    items: T[]
    children: (item: T) => ReactElement
    estimateSize: number
}

export function VirtualList<T>({ items, children, estimateSize, className, ref, ...rest }: VirtualScrollProps<T>) {
