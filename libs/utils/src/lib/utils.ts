...
export function formatHours(minutes = 0) {
  return new Intl.NumberFormat('en-AU', { maximumFractionDigits: 1, minimumFractionDigits: 1 }).format(minutes / 60)
}
